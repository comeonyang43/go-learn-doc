...
[gRPC](https://grpc.io/) 是一个高性能、开源、通用的`RPC`框架，由`Google`推出，基于[HTTP2](https://http2.github.io/)协议标准设计开发，默认采用[Protocol Buffers](https://developers.google.com/protocol-buffers/)数据序列化协议，支持多种开发语言。`gRPC`提供了一种简单的方法来精确的定义服务，并且为客户端和服务端自动生成可靠的功能库。



## 2.gRPC技术栈

![](https://go.liuqh.icu/img/image-20220120230734308.png)
...
> <font color=red><b>安装插件的目的是为了将`protobuf`文件，生成`Go`代码</b></font>
